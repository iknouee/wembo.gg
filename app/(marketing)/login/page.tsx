      ...
      <div className={`relative w-full max-w-md transition-all duration-700 ${isVisible ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 translate-y-4'}`}>
        <div className="rounded-2xl border border-white/[0.08] bg-[#0a0b0d] p-8 shadow-2xl shadow-black/30">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-[#9A9CA3] mt-1.5">Sign in to access your Wembo dashboard</p>
          </div>
          ...
          <div className="mt-6 flex items-start gap-2.5 p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <p className="text-xs text-[#9A9CA3]/70 leading-relaxed">We only request access to your Discord identity and server list. We never read your messages or access private data.</p>
          </div>

          <div className="mt-6 text-center">
            <p className="text-xs text-[#9A9CA3]/50">Don&apos;t have Wembo yet?{' '}<Link href="/invite" className="text-[#FFD600] hover:text-[#FFD600]/80 transition-colors">Add Wembo to your server</Link></p>
          </div>
        </div>

        <p className="text-xs text-center text-[#9A9CA3]/30 mt-5">By signing in, you agree to our{' '}<Link href="#" className="underline hover:text-white/50 transition-colors">Terms</Link>{' '}and{' '}<Link href="#" className="underline hover:text-white/50 transition-colors">Privacy Policy</Link>.</p>
      </div>
    </div>
  )
}
